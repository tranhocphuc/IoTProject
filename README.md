...
Multiple online sources provided ways to set up the EC2 instance and AwS IoT Core. One among which is this really good [article](https://aws.amazon.com/blogs/iot/how-to-bridge-mosquitto-mqtt-broker-to-aws-iot) from AwS themselves to setup Brokers on both EC2 and AwS IoT Core. 
